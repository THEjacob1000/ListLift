...
const TaskForm = ({
  ...
  return (
    <DrawerContent className="mr-7">
      <Form {...form}>
        <form
          onSubmit={form.handleSubmit(onSubmit)}
          className="flex flex-col gap-4 p-4 pr-12"
        >
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Textarea
                      placeholder="Description"
                      className="w-full p-2 bg-card h-fit text-md border-none outline-none"
                      {...field}
                    />
                  </FormControl>
                </FormItem>
                    ...
                    <FormControl>
                      <DropdownMenu>
                        <DropdownMenuTrigger>
                          <Button
                            variant={"outline"}
                            className="flex gap-2 px-3 justify-start w-fit"
                          >
                            <Flag
                              color={getPriorityColor(
                                field.value as Priority
                      ...
                      >
                        <DropdownMenu>
                          <DropdownMenuTrigger>
                            <Button
                              variant={"outline"}
                              className="flex gap-2 px-4 justify-start w-fit"
                            >
                              <Tag size={16} />
                              {field.value
                                ? categories.find(
